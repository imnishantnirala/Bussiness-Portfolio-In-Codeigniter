                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <?php
                                                $i=0;
                                                foreach($this->amodels->select_logo() as $logo ){
                                                $i++;
                                            ?>
                                            
                                            <tr>
                                                
                                                <td><img style="height: 200px" src="<?=base_url();?>images/logo/<?=$logo->logo_img?>"></td>
                                                
                                                
                                                <td> <a href="<?=site_url('admin/update_logo/'.$logo->logo_id);?>"> <button>Update</button> </a> </td>
